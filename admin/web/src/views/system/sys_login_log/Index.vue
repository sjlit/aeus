...
// 与 router/index.ts 里菜单路由 meta.componentName (= deriveComponentName('@/views/system/sys_login_log/Index.vue')) 对齐。
...
-->
<template>
  <SchemaViewer module="system" table="sys_login_logs" :title="title" />
</template>
