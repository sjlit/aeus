...
// management requires).
type Tenant struct {
	ID        string         `json:"id" yaml:"id" xml:"id" gorm:"primaryKey;column:id;type:char(60)" comment:"租户" props:"readonly:update" scenarios:"create;update;view;list;search;detail;export"`
