...
type Department struct {
	...
	ParentID    uint   `json:"parent_id" yaml:"parentId" xml:"parentId" gorm:"index;column:parent_id" comment:"父级部门" format:"department" live:"type:dropdown;url:/department/level-labels"`
